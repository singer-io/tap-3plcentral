...
#   'facility_locations': ['facility_id', 'location_id'],
#   'inventory': ['customer_id', 'facility_id', 'location_id', 'item_id'],
#   'stock_details': ['customer_id', 'facility_id', 'location_id', 'item_id']
